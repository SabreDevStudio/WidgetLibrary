/*1425688634,,JIT Construction: v1630024,en_US*/
...
try {
    window.FB || (function (window) {
        ...
        var ES = require('ES');
        __d("JSSDKRuntimeConfig", [], {"locale": "en_US", "rtl": false, "revision": "1630024"});
        __d("JSSDKConfig", [], {
            "bustCache": true,
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1630024","message":"' + e.message + '"}}');
}