if (!window.criteo_q || window.criteo_q instanceof Array) {
    ...
    window.criteo_q = function () {
        var e = {bodyReady: !1, domReady: !1, queue: [], actions: [], disingScheduled: [], accounts: []}, d = {
            ...
            e.queue = a || [];
            !d.manualFlush && (!d.noPartialFlush || 0 === e.queue.length) && r(0 !== e.queue.length)
        }, k = function (a, b, c, h) {
            if (!e.domReady && a.requiresDOM && "no" !== a.requiresDOM)return "blocking" ===
            a.requiresDOM ? -1 : 0;
            ...
            switch (a.event) {
                case "setdata":
                    return a = f(a), d.extraData.push(a), s(e.actions, f(a)), 1;
                case "setparameter":
                ...
                case "setemail":
                case "setlogin":
                    return a.hasOwnProperty("hash_method") || (a.hash_method = "none"), a.hasOwnProperty("email") && (a.email && !(a.email instanceof Array)) && (a.email = [a.email]), a.hasOwnProperty("login") && (a.login && !(a.login instanceof Array)) && (a.login = [a.login]), b = f(a), d.customerInfo.push(b), t(e.actions, f(a)), 1;
                case "sethashedlogin":
                case "clh":
                    return a.event = "setlogin", a.hasOwnProperty("hash_method") ||
                    (a.hash_method = "md5"), k(a);
                case "sethashedemail":
                case "ceh":
                ...
                case "setsitetype":
                    ...
                    return k(a);
                case "appendtag":
                    e.bodyReady && !d.container && ((b = document.body) ? (c = document.createElement("div"), c.setAttribute("id", "criteo-tags-div"), c.style.display = "none", b.appendChild(c), b = c) : b = void 0, d.container =
                        b);
                    d.beforeAppend instanceof Function && (a.element = d.beforeAppend(a.element, e, d));
                    f(a);
                    if (a.element && a.element.tagName)if (!d.container && "script" === a.element.tagName.toLowerCase())b = document.getElementsByTagName("script")[0], a.element.setAttribute("data-owner", "criteo-tag"), b.parentNode.insertBefore(a.element, b); else if (d.container)d.container.appendChild(a.element); else return 0;
                    return 1;
                case "gettagstate":
            ...
            if (0 !== e.actions.length) {
                ...
                if (!d.manualDising && (!a || d.partialDis)) {
                    a = [];
                    for (b = 0; b < e.accounts.length; ++b)n(e.disingScheduled, e.accounts[b]) ||
                    a.push(e.accounts[b]);
                ...
                b.setAttribute("src",
                    d.handlerUrlPrefix + "?" + a);
                e.actions = [];
                k({event: "appendTag", element: b});
            ...
            if (a instanceof Array)for (var b = [], c = 0; c < a.length; ++c)b[c] = f(a[c]); else if (a && "[object Object]" === a.toString())for (c in b = {}, a)a.hasOwnProperty(c) && (b[c] = f(a[c]));
            return b
        }, v = function (a, b) {
            var c = b.join(".");
            ...
            function (a, b) {
                if (a instanceof Array)for (var c = 0; c < a.length; ++c)q(a[c], b); else n(b, a) || b.push(a)
            }, n = function (a, b) {
        ...
        (function (a, b) {
            if ("complete" === a.readyState)b(); else if (a.addEventListener)a.addEventListener("DOMContentLoaded",
                b, !1), window.addEventListener("load", b, !1); else {
                ...
                if (c && c.doScroll)(function w() {
                    ...
                    a.onload = a.onreadystatechange = function () {
                        ...
                        if (!e && (!a.readyState || "loaded" === a.readyState || "complete" === a.readyState))f instanceof Function &&
                        f(), e = !0, b()
                    }
                }
            }
