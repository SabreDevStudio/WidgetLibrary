/*1425946482,,JIT Construction: v1633075,en_US*/
...
try {
    window.FB || (function (window) {
        ...
        __d("ie8DontEnum", [], function (a, b, c, d, e, f) {
            ...
            if (({toString: true}).propertyIsEnumerable('toString'))i = function (j, k) {
        ...
        __d("ES", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3", "ES6Object", "ES6ArrayPrototype", "ES6DatePrototype", "ES6Number"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
            var r = ({}).toString, s = {
                ...
                Array: j,
                Date: l
            }, u = {Object: n, 'Array.prototype': o, 'Date.prototype': p, Number: q};
        ...
        var ES = require('ES');
        __d("JSSDKRuntimeConfig", [], {"locale": "en_US", "rtl": false, "revision": "1633075"});
        __d("JSSDKConfig", [], {
            "bustCache": true,
        ...
        __d("JSSDKXDConfig", [], {
            ...
            "XdBundleUrl": "\/connect\/xd_arbiter\/rFG58m7xAig.js?version=41",
            "Flash": {"path": "https:\/\/connect.facebook.net\/rsrc.php\/v1\/yW\/r\/yOZN1vHw3Z_.swf"},
            "useCdn": true
        });
        __d("JSSDKCssConfig", [], {
        ...
        __d("Assert", ["AssertionError", "sprintf"], function (a, b, c, d, e, f, g, h) {
            ...
            var m = {
                isInstanceOf: k, isTrue: i, isTruthy: function (n, o) {
                    return i(!!n, o);
        ...
        __d("sdk.Runtime", ["sdk.Model", "JSSDKRuntimeConfig"], function (a, b, c, d, e, f, g, h) {
            ...
            ES('Object', 'assign', false, j, {
                ENVIRONMENTS: i, isEnvironment: function (k) {
        ...
        __d("insertIframe", ["GlobalCallback", "getBlankIframeSrc", "guid"], function (a, b, c, d, e, f, g, h, i) {
            function j(k) {
                ...
                if (document.attachEvent) {
                    ...
                    if (k.width !== (void 0))if (k.width == '100%') {
        ...
        __d("sdk.Impressions", ["sdk.Content", "Miny", "QueryString", "sdk.Runtime", "UrlMap", "getBlankIframeSrc", "guid", "insertIframe"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            function o(q) {
                ...
                if (t.length > 2000)if (q.payload && typeof q.payload === 'string') {
                ...
                if (t.length <= 2000) {
                    ...
                    n({
                        url: l(), root: x, name: w, className: 'fb_hidden fb_invisible', onload: function () {
        ...
        __d("sdk.RPC", ["Assert", "JSONRPC", "Queue"], function (a, b, c, d, e, f, g, h, i) {
            var j = new i(), k = new h(function (m) {
                ...
                local: k.local, remote: k.remote, stub: ES(k.stub, 'bind', true, k), setInQueue: function (m) {
                    g.isInstanceOf(i, m);
                    m.start(function (n) {
                        k.read(n);
                    });
            ...
            h.subscribe('init:post', function (ta) {
                ...
                if (ua)setTimeout(function () {
                    ...
                    if (!va)n.log('jssdk_error', {
                        ...
                        extra: {message: 'Failed to initialize in ' + ua + 'ms'}
                    });
                }, ua);
            });
            e.exports = sa;
        ...
        __d("ApiClient", ["ArgumentError", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig", "invariant"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
            var u, v, w, x = {get: true, post: true, 'delete': true, put: true}, y = {
                fql_query: true,
                fql_multiquery: true,
                friends_get: true,
            ...
            function ja() {
                ...
                ha('/', 'POST', {batch: ma, include_headers: false, batch_app_id: v || da}, function (ra) {
                    if (ES('Array', 'isArray', false, ra)) {
                        ...
                        return sa({error: {message: 'Fatal: batch call failed.'}});
                    });
                });
            }
            ...
            var la = ES('Object', 'assign', false, new n(), {
                setAccessToken: function (ma) {
                    ...
                    w = ma;
                }, rest: ka, graph: ha, scheduleBatchCall: ia
            });
        ...
        __d("sdk.api", ["ApiClient", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
            var m = l('should_log_response_error', false), n;
            ...
            g.subscribe('request.complete', function (p, q, r, s) {
                var t = false;
                if (s && typeof s == 'object')if (s.error) {
                    if (s.error == 'invalid_token' || (s.error.type == 'OAuthException' && s.error.code == 190))t = true;
                } else if (s.error_code)if (s.error_code == '190')t = true;
            ...
            g.subscribe('request.error', function (p, q, r, s) {
                if (m && s.error.type === 'http')j.log('jssdk_error', {
                    appId: i.getClientID(),
                    error: 'transport',
                    extra: {name: 'transport', message: ES('JSON', 'stringify', false, s.error)}
                });
            });
            function o(p) {
                if (typeof p === 'string') {
                    if (i.getIsVersioned()) {
                        ...
                        p = k(p).setDomain(null).setProtocol(null).toString();
        ...
        __d("sdk.AppEvents", ["Assert", "sdk.Impressions", "merge", "sdk.Runtime"], function (a, b, c, d, e, f, g, h, i, j) {
            ...
            function p(t, u, v, w) {
                ...
                if (w)x.cd = w;
                h.impression({api_key: t, payload: ES('JSON', 'stringify', false, x)});
            }
        ...
        __d("sdk.Frictionless", ["sdk.Auth", "sdk.api", "sdk.Event", "sdk.Dialog"], function (a, b, c, d, e, f, g, h, i, j) {
            var k = {
                _allowedRecipients: {}, _useFrictionless: false, _updateRecipients: function () {
        ...
        __d("sdk.UIServer", ["sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Frictionless", "Log", "sdk.Native", "QueryString", "sdk.RPC", "sdk.Runtime", "JSSDKConfig", "sdk.UA", "UrlMap", "sdk.XD", "createObjectFrom", "sdk.feature", "flattenObject", "sdk.getContextType", "guid", "insertIframe", "resolveURI"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba) {
            var ca = {
                ...
                'stream.share': {
                    size: {width: 670, height: 340}, url: 'sharer.php', transform: function (ia) {
                ...
                'permissions.oauth': {
                    url: 'dialog/oauth',
                    size: {width: (s.mobile() ? null : 475), height: (s.mobile() ? null : 183)},
                    transform: function (ia) {
                        if (!q.getClientID()) {
                        ...
                        if (g.getAuthResponse() && !ia.params.scope && !ia.params.auth_type) {
                            ...
                            ia.cb && ia.cb({status: q.getLoginStatus(), authResponse: g.getAuthResponse()});
                            return;
                        }
                        var ja = ia.cb, ka = ia.id;
                        delete ia.cb;
                ...
                'auth.logout': {
                    url: 'logout.php', transform: function (ia) {
                        if (!q.getClientID()) {
                ...
                'login.status': {
                    url: 'dialog/oauth', transform: function (ia) {
                        var ja = ia.cb, ka = ia.id;
                        delete ia.cb;
                        ES('Object', 'assign', false, ia.params, {
                            client_id: q.getClientID(),
            ...
            var ha = {
                ...
                checkOauthDisplay: function (ia) {
                    ...
                    var ka = ja.split(/\s|,/g);
                    for (var la = 0; la < ka.length; la++)if (!r.initSitevars.iframePermissions[ES(ka[la], 'trim', true)])return 'popup';
                    return ia.display;
                },
                prepareCall: function (ia, ja) {
                    var ka = ia.method.toLowerCase(), la = ha.Methods.hasOwnProperty(ka) ? ES('Object', 'assign', false, {}, ha.Methods[ka]) : {}, ma = z(), na = q.getSecure() || (ka !== 'auth.status' && ka != 'login.status');
                    ...
                    if (ga(ia)) {
                        if (ea[ka]) {
                            ...
                            m.warn(oa);
                            ja({error_code: -100, error_message: oa});
                            return;
                        }
                        ja = fa(ja, ka);
                    }
                    ...
                    var ra = la.getXdRelation || ha.getXdRelation, sa = ra(pa.params);
                    if (!(pa.id in ha._defaultCb) && !('next' in pa.params) && !('redirect_uri' in pa.params))pa.params.next = ha._xdResult(pa.cb, pa.id, sa, true);
                    if (sa === 'parent')ES('Object', 'assign', false, pa.params, {channel_url: ha._xdChannelHandler(ma, 'parent.parent')}, true);
                ...
                popup: function (ia) {
                    ...
                    if (ia.post) {
                        ...
                        if (ta) {
                            ...
                            h.submitToTarget({url: ia.url, target: ia.id, params: ia.params});
                        }
                    } else {
                ...
                setLoadedNode: function (ia, ja, ka) {
                    ...
                    ja = {node: ja, type: ka, fbCallID: ia.id};
                    ha._loadedNodes[ia.id] = ja;
                },
                getLoadedNode: function (ia) {
                    var ja = typeof ia == 'object' ? ia.id : ia, ka = ha._loadedNodes[ja];
                ...
                _insertIframe: function (ia) {
                    ...
                    if (ia.post) {
                        aa({
                            ...
                            onInsert: ja,
                            onload: function (ka) {
                                h.submitToTarget({url: ia.url, target: ka.name, params: ia.params});
                            }
                        });
                    } else aa({
                        url: ia.url,
                ...
                _triggerDefault: function (ia) {
                    ha._xdRecv({frame: ia}, ha._defaultCb[ia] || function () {
                    });
                },
                _popupMonitor: function () {
                    var ia;
                    for (var ja in ha._loadedNodes)if (ha._loadedNodes.hasOwnProperty(ja) && ja in ha._defaultCb) {
        ...
        __d("PluginPipe", ["sdk.Content", "sdk.feature", "guid", "insertIframe", "Miny", "ObservableMixin", "JSSDKPluginPipeConfig", "sdk.Runtime", "sdk.UA", "UrlMap", "XFBML"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
            ...
            function w(x) {
                ...
                ES(x, 'forEach', true, function (ea) {
                    z[ea.config.name] = {plugin: ea.tag, params: ea.params};
                });
                ...
                j({
                    url: 'about:blank', root: y, name: da, className: 'fb_hidden fb_invisible', onload: function () {
                        g.submitToTarget({url: ca, target: da, params: {plugins: ba.length < aa.length ? ba : aa}});
                    }
                });
            }
        ...
        __d("IframePlugin", ["sdk.Auth", "sdk.DOM", "sdk.Event", "Log", "ObservableMixin", "sdk.PlatformVersioning", "PluginPipe", "QueryString", "sdk.Runtime", "Type", "sdk.UA", "sdk.URI", "UrlMap", "sdk.XD", "sdk.createIframe", "sdk.feature", "guid", "resolveURI"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x) {
            ...
            var ba = {
                string: function (ha) {
                    ...
                    return ha ? (/^(?:true|1|yes|on)$/i).test(ha) : (void 0);
                }, url: function (ha) {
                    return x(ha);
                    ...
                    return (/^(\d+)(?:px)?$/).test(ha) ? parseInt(RegExp.$1, 10) : (void 0);
                }, text: function (ha) {
                    return ha;
                }
            };
            ...
            var ga = p.extend({
                constructor: function (ha, ia, ja, ka) {
                    ...
                    var ma = o.getSecure() || window.location.protocol == 'https:', na = s.resolve('www', ma) + '/plugins/' + ja + '.php?', oa = {};
                    ...
                    this.subscribe('xd.verify', function (ra) {
                        t.sendToFacebook(pa, {method: 'xd/verify', params: ES('JSON', 'stringify', false, ra.token)});
                    });
                    ...
                    if (q.mobile()) {
                        ...
                        if (!this._iframeOptions.width) {
                            ...
                            var la = {height: 'auto', position: 'static', width: '100%'};
                    ...
                    var ia = h.getPosition(this._iframe).x, ja = h.getViewportInfo().width, ka = parseInt(h.getStyle(this._iframe, 'width'), 10), la = {};
                    if ((ia + ha) > ja && ia > ha) {
        ...
        __d("PluginConfig", ["sdk.feature"], function (a, b, c, d, e, f, g) {
            var h = {post: {fluid: g('fluid_embed', false), mobile_fullsize: true}, page: {fluid: true}};
            e.exports = h;
        }, null);
        __d("PluginTags", [], function (a, b, c, d, e, f) {
            var g = {
                ...
                composer: {action_type: 'string', action_properties: 'string'},
                create_event_button: {},
                degrees: {href: 'url'},
                facepile: {href: 'string', action: 'string', size: 'string', max_rows: 'string', show_count: 'bool'},
                follow: {href: 'url', layout: 'string', show_faces: 'bool'},
                like: {
                    href: 'url',
                    layout: 'string',
                    show_faces: 'bool',
                ...
                open_graph_preview: {action_type: 'string', action_properties: 'string'},
                page_events: {href: 'url'},
                post: {href: 'url', show_border: 'bool'},
                privacy_selector: {},
                profile_pic: {uid: 'string', linked: 'bool', href: 'string', size: 'string', facebook_logo: 'bool'},
                recommendations: {
                    filter: 'string',
                    action: 'string',
                    max_age: 'string',
                ...
                share_button: {href: 'url', layout: 'string', type: 'string'},
                shared_activity: {header: 'bool'},
                send: {href: 'url'},
                send_to_mobile: {max_rows: 'string', show_faces: 'bool', size: 'string'},
                story: {href: 'url', show_border: 'bool'},
                topic: {topic_name: 'string', topic_id: 'string'},
                want: {href: 'url', layout: 'string', show_faces: 'bool'}
            }, h = {subscribe: 'follow', fan: 'like_box', likebox: 'like_box', friendpile: 'facepile'};
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1633075","message":"' + e.message + '"}}');
}