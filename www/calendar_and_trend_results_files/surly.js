(function () {
    ...
    function q(a, d) {
        ...
        -1 < navigator.userAgent.indexOf("MSIE ") && (b.onreadystatechange = function () {
            if (!c && ("loaded" == this.readyState || "complete" == this.readyState))c = !0, b.onload(), b.onload = null
        });
        var f = function (a) {
    ...
    var a, c, d = {}, r = document.getElementsByTagName("SCRIPT"), e = "http" + ("https:" == document.location.protocol ? "s" : "") + "://c.betrad.com", h = "432e97f";
