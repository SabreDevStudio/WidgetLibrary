(function (z) {
    z.fn.carousel = function (a) {
        ...
        return this.each(function () {
            ...
            b.$elts.content = z(this).children().css({position: "absolute", top: 0});
            b.$elts.wrap = b.$elts.content.wrap('<div class="carousel-wrap"></div>').parent().css({
                overflow: "hidden",
                position: "relative"
            });
            b.steps = {first: 0, count: b.$elts.content.children().length};
            b.$elts.loader = z('<div class="loader"></div>').css({position: "absolute"});
            ...
            b.lastItemsToLoad;
            C(b);
            b.$elts.carousel.attr("tabindex", 0).add(b.$elts.carousel.children()).bind({
                focus: function (c) {
            ...
            z(function () {
                ...
                if (a.stopSlideBtn == true) {
                    b.$elts.stopSlideBtn = z('<button type="button" class="slide-control play">' + a.stopSlideTextPause + "</button>");
                    F(b)
                }
            })
        })
    ...
    function D(b) {
        ...
        if (b.params.direction == "vertical") {
            ...
            b.$elts.content.parent().css({height: b.itemHeight * b.params.dispItems + "px"})
        } else {
    ...
    function C(a) {
        a.$elts.nextBtn.add(a.$elts.prevBtn).bind("enable", function () {
            var b = z(this).unbind("click").bind("click", function () {
                if (a.params.ajaxMode && b.is(".next") && E(a) == (q(a) - 1) && !a.lastItemsToLoad) {
                    y(a);
            ...
            if (a.params.combinedClasses) {
                b.removeClass("next-disabled previous-disabled").removeAttr("disabled")
            }
        }).bind("disable", function () {
            var b = z(this).unbind("click").addClass("disabled").attr("disabled", "disabled");
            if (a.params.combinedClasses) {
                if (b.is(".next")) {
    ...
    function r(a) {
        a.$elts.pagination = z('<div class="center-wrap"><div class="carousel-pagination"><p></p></div></div>')[((a.params.paginationPosition == "outside") ? "insertAfter" : "appendTo")](a.$elts.carousel).find("p");
    ...
    function v(a, b) {
        if (a.params.pagination) {
            a.$elts.paginationBtns = a.$elts.paginationBtns.add(z('<a role="button"><span>' + a.params.tabLabel(a.$elts.paginationBtns.length + 1) + "</span></a>").data("firstStep", b)).appendTo(a.$elts.pagination);
        ...
        if (b == "prev") {
            ...
            if (b == "next") {
                if ((a.steps.first + a.params.dispItems) < a.steps.count) {
                    if (!a.params.showEmptyItems) {
                        return Math.min(a.steps.first + a.params.dispItems, a.steps.count - a.params.dispItems)
                    } else {
                        return a.steps.first + a.params.dispItems
                    }
                } else {
    ...
    function u(b, a) {
        switch (b.params.effect) {
            ...
            case"fade":
                if (b.params.direction == "vertical") {
                    b.$elts.content.hide().css("top", -(b.itemHeight * a) + "px").fadeIn(b.params.animSpeed)
                } else {
                    b.$elts.content.hide().css("left", -(b.itemWidth * a) + "px").fadeIn(b.params.animSpeed)
                }
                break;
            default:
                if (b.params.direction == "vertical") {
                    b.$elts.content.stop().animate({top: -(b.itemHeight * a) + "px"}, b.params.animSpeed, b.params.slideEasing)
                } else {
                    b.$elts.content.stop().animate({left: -(b.itemWidth * a) + "px"}, b.params.animSpeed, b.params.slideEasing)
                }
                break
        }
    }
    ...
    function x(a) {
        ...
        if (a.params.pagination) {
            a.$elts.paginationBtns.removeClass("active").filter(function () {
    ...
    function F(a) {
        ...
        b.bind({
            play: function () {
                A(a);
                b.removeClass("pause").addClass("play").html(a.params.stopSlideTextPause)
            }, pause: function () {
                t(a);
                b.removeClass("play").addClass("pause").html(a.params.stopSlideTextPlay)
            }
        });
        b.click(function (c) {
            if (b.is(".play")) {
    ...
    function y(a) {
        ...
        z.ajax({
            url: a.params.ajaxUrl, dataType: "json", success: function (b) {
                a.lastItemsToLoad = b.bLastItemsToLoad;
                z(a.$elts.content).append(b.shtml);
                a.steps = {first: a.steps.first + a.params.dispItems, count: a.$elts.content.children().length};
...
if (location.href.indexOf("https") > -1) {
    location.assign("http://www.submarinoviagens.com.br/default.aspx")
}
$(document).ready(function () {
    $(".ofertasEspeciais div.carro").carousel({loop: true, animSpeed: "slow"});
    $(".destaqueDestino div.carro").carousel({loop: true, effect: "fade"})
});