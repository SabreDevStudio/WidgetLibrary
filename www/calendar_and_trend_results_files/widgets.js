!function t(e, i, n) {
    ...
    2: [function (t, e) {
        ...
        var o = t("assets/refresh"), s = t("i18n/util"), a = t("tfw/util/assets"), l = t("var/thumbprints"), u = "embed/timeline.css";
        e.exports = {tweet: r(n.bind(null, "tweet")), timeline: i, video: r(n.bind(null, "video"))}
    }, {"assets/refresh": 3, "i18n/util": 18, "tfw/util/assets": 35, "var/thumbprints": 70}],
    3: [function (t, e) {
        function i() {
    ...
    }, {"env/window": 12, "globals/pagemetadata": 15, "util/typevalidator": 64, "util/util": 67}],
    4: [function (t, e) {
        function i(t) {
    ...
    }, {"env/window": 12, "util/util": 67}],
    15: [function (t, e) {
        function i(t) {
            var e, i, n, s = 0;
            for (r = {}, t = t || o, e = t.getElementsByTagName("meta"); i = e[s]; s++)/^twitter:/.test(i.name) && (n = i.name.replace(/^twitter:/, ""), r[n] = i.content)
        }
    ...
    }, {"dom/delegate": 5, "dom/get": 6, "env/location": 10, "tfw/widget/intent": 43, "util/twitter": 63}],
    20: [function (t, e) {
        function i(t) {
            var e = [];
    ...
    }, {"env/window": 12, "util/options_parser": 58, "util/twitter": 63, "util/uid": 65, "util/util": 67}],
    21: [function (t, e) {
        function i(t) {
            l[t] = +new Date
        }
        ...
        function o(t, e, i, n, r) {
            ...
            100 * Math.random() > l || (i = a.aug(i || {}, {duration_ms: n}), o = {
                page: e,
    ...
    }, {"rpc/jsonrpc/errors": 22, "util/promise": 60, "util/util": 67}],
    24: [function (t, e) {
        function i(t, e) {
    ...
    }, {"env/location": 10, "env/window": 12, "util/env": 53, "util/promise": 60, "util/twitter": 63, "util/util": 67}],
    25: [function (t, e) {
        function i(t, e, i, r) {
            var a, l = this;
    ...
    }, {"env/document": 9, "globals/private": 16, "util/env": 53, "util/iframe": 55, "util/promise": 60}],
    26: [function (t, e) {
        function i() {
            var t, e;
            g = {}, o || (t = s.body.offsetHeight, e = s.body.offsetWidth, (t != v || e != w) && (p.forEach(function (t) {
                t.dispatchFrameResize(w, v)
            }), v = t, w = e))
        }

        function n(t) {
            var e;
            return t.id ? t.id : (e = t.getAttribute("data-twttr-id")) ? e : (e = "twttr-sandbox-" + m++, t.setAttribute("data-twttr-id", e), e)
        }

        function r(t, e) {
            var i = this;
            u.apply(this, [t, e]), this._resizeHandlers = [], p = p.filter(function (t) {
                var e = t._frame.parentElement;
                return e || h.async(function () {
                    f.removeDelegatesForWidget(t._frame.id)
                }), e
            }), p.push(this), this._win.addEventListener("resize", function () {
                i.dispatchFrameResize()
            }, !1)
        }

        var o, s = t("env/document"), a = t("env/window"), l = t("sandbox/baseframe"), u = t("sandbox/minimal"), c = t("util/env"), d = t("util/promise"), h = t("util/util"), f = t("dom/delegate"), m = 0, p = [], g = {}, w = 0, v = 0;
        a.addEventListener("resize", i, !1), r.prototype = new u, h.aug(r.prototype, {
            dispatchFrameResize: function () {
                var t = this._frame.parentNode, e = n(t), i = g[e];
                o = !0, this._resizeHandlers.length && (i || (i = g[e] = {
    ...
    }, {"sandbox/baseframe": 25, "util/util": 67}],
    28: [function (t, e) {
        function i() {
    ...
    }, {"scribe/pixel": 30, "scribe/util": 31, "util/tld": 62}],
    29: [function (t, e) {
        function i() {
            return E ? A : (p.createSandbox({id: "rufous-sandbox"}, {display: "none"}).then(function (t) {
        ...
        var u, c, d, h, f = t("util/iframe"), m = t("util/donottrack"), p = t("sandbox/minimal"), g = t("util/promise"), w = t("scribe/util"), v = t("util/util"), b = t("globals/twttr"), y = Math.floor(1e3 * Math.random()) + "_", _ = "rufous-frame-" + y + "-", T = "rufous-form-" + y + "-", x = 0, E = !1, A = new g(function (t) {
            h = t
        });
    ...
    }, {"scribe/util": 31, "util/donottrack": 52, "util/querystring": 61, "util/util": 67}],
    31: [function (t, e) {
        function i(t, e) {
            var n;
        ...
        var l = t("env/document"), u = t("util/donottrack"), c = t("util/util"), d = t("var/build"), h = t("globals/private"), f = d.version, m = h.get("endpoints.rufous") || "https://syndication.twitter.com/i/jot", p = h.get("endpoints.rufous") || "https://syndication.twitter.com/i/jot/syndication", g = h.get("endpoints.rufousRedirect") || "https://platform.twitter.com/jot.html";
        e.exports = {
    ...
    }, {"env/document": 9, "globals/private": 16, "util/donottrack": 52, "util/util": 67, "var/build": 69}],
    32: [function (t, e) {
        function i(t, e, i, n) {
    ...
    33: [function (t, e) {
        ...
        function r(t) {
            var e = a.base(t) + "/widgets/hub.0e7931819b6cfb483aa5ddbe7670a1c6.html", r = n(t);
    ...
    }, {"env/window": 12, "util/document": 50, "util/donottrack": 52}],
    35: [function (t, e) {
        function i(t, e) {
            var i, o = l[t];
            return "embed/timeline.css" === t && a.contains(r.href, "localhost.twitter.com") ? "/components/syndication-templates/lib/css/index.css" : (i = s.retina() ? "2x" : "default", e && (i += ".rtl"), n() + "/" + o[i])
        }
        ...
        var r = t("env/location"), o = t("globals/private"), s = t("util/env"), a = t("util/util"), l = {
            "embed/timeline.css": {
                "default": "embed/timeline.ba2a91a7d215f48be9997d41ee8f8d7a.default.css",
                "2x": "embed/timeline.ba2a91a7d215f48be9997d41ee8f8d7a.2x.css",
                gif: "embed/timeline.ba2a91a7d215f48be9997d41ee8f8d7a.gif.css",
                "default.rtl": "embed/timeline.ba2a91a7d215f48be9997d41ee8f8d7a.default.rtl.css",
                "2x.rtl": "embed/timeline.ba2a91a7d215f48be9997d41ee8f8d7a.2x.rtl.css",
                "gif.rtl": "embed/timeline.ba2a91a7d215f48be9997d41ee8f8d7a.gif.rtl.css"
            }
        }, u = function () {
    ...
    }, {"env/location": 10, "globals/private": 16, "util/env": 53, "util/util": 67}],
    36: [function (t, e) {
        function i(t) {
            return function (e) {
        ...
        var o = t("env/document"), s = t("env/location"), a = t("assets/refresh"), l = t("globals/private"), u = t("util/logger"), c = t("util/util"), d = t("util/querystring"), h = "cb", f = 0, m = !1, p = {}, g = c.aug({
        ...
        p.jsonp = function (t, e, n) {
            var r = n || h + f, a = l.fullPath(["callbacks", r]), u = o.createElement("script"), c = {
                callback: a,
            ...
            var e, i = r(t), n = 9e5, o = Math.floor(+new Date / n), a = {
                lang: t.lang,
                t: o,
                domain: s.host,
                dnt: t.dnt,
    ...
    }, {"env/location": 10, "util/params": 59}],
    38: [function (t, e) {
        function i(t, e) {
            return 2 == t || 3 == t && 0 === +e
        }
        ...
        function r(t, e, i) {
            ...
            if (t = c.devicePixelRatio ? t * c.devicePixelRatio : t, o = e.split(",").map(function (t) {
                    return new n(t)
                }), i)for (a = 0; a < o.length; a++)o[a].url === i && (r = o[a]);
        ...
        function a(t, e, n, r) {
            ...
            if (t)return d.toRealArray(t.querySelectorAll(".autosized-media")).forEach(function (t) {
    ...
    }, {"env/window": 12, "util/env": 53, "util/twitter": 63, "util/util": 67}],
    39: [function (t, e) {
    ...
    }, {"util/querystring": 61, "util/twitter": 63}],
    40: [function (t, e) {
        function i(t) {
            var e, i = this;
        ...
        var o, s = t("env/document"), a = t("env/window"), l = t("tfw/util/assets"), u = t("performance/perf-timers"), c = t("util/iframe"), d = t("util/layout"), h = t("util/promise"), f = t("util/querystring"), m = t("util/typevalidator"), p = t("util/util"), g = t("globals/pagemetadata"), w = t("util/donottrack"), v = t("util/logger"), b = t("util/document"), y = t("globals/twttr"), _ = 0, T = {}, x = [], E = new d, A = "data-twttr-rendered", I = {
            ar: {
    ...
    41: [function (t, e) {
        function i(t, e) {
            ...
            r && (s[r] = {item_type: 0}, y.clientEvent({
                page: "tweet",
                section: "subject",
                component: "tweet",
                action: "results"
                ...
                item_ids: [r],
                item_details: s
            }), !0), b.scribeTweetAudienceImpression(), o && (a[o] = {item_type: 0}, y.clientEvent({
                page: "tweet",
        ...
        function n(t, e) {
            var i = {};
            t && (i[t] = {item_type: 0}, y.clientEvent({
                page: "tweet",
                section: "subject",
        ...
        function r(t, e, i, n) {
            N[t] = N[t] || [], N[t].push({s: i, f: n, lang: e})
        }
        ...
        o.prototype = new u, g.aug(o.prototype, {
            ...
            create: function (t) {
                ...
                return o.innerHTML = t, (e = o.children[0] || !1) ? ("dark" == this.theme && this.classAttr.push("thm-dark"), this.linkColor && this.addSiteStyles(), h.present(e, "media-forward") && (this.fullBleedPhoto = !0, this.dimensions.maxHeight = this.dimensions.FULL_BLEED_PHOTO_MAX_HEIGHT), _.retinize(e), e.id = this.id, e.className += " " + this.classAttr.join(" "), e.lang = this.lang, this.sandbox.setTitle(e.getAttribute("data-iframe-title") || "Tweet"), this.sandbox.appendChild(e).then(function () {
            ...
            render: function () {
                ...
                return i ? (this.hideCard && (e += "c"), this.hideThread && (e += "t"), e && (i += "-" + e), this.rendered().then(function (e) {
                    ...
                    i && i.parentNode && t.layout(function () {
                        ...
                        margin: "7px auto",
                        cssFloat: "none"
                    }) : t.align && (t.width == t.dimensions.DEFAULT_WIDTH && (t.predefinedWidth = t.width = t.dimensions.NARROW_WIDTH), e.style({cssFloat: t.align})), t.layout(function () {
                ...
                }), S.push(this.completed()), this.completed().then(this.scribePerformance.bind(this)), this.completed()) : (this.completeResolver.fulfill(this.srcEl), this.completed())
            },
            bindPermalinkHandler: function () {
                ...
                h.present(this.element, "decider-tapOpensPermalink") && (E.delegate(this.element, "click", "A", function (t) {
                    ...
                    var i = this.querySelectorAll("blockquote.tweet"), n = i[i.length - 1];
            ...
            handleResize: function (t) {
                ...
                t != this.width && (this.width = t, this.setNarrow(), this.constrainMedia(this.element, this.contentWidth(t)), this.collapseRegions(), this.layout(function () {
                    e.height = e.sandbox.height(e.element.offsetHeight), x.get("events").trigger("resize", {target: e.sandbox.element()})
                }), l.doLayoutAsync())
            },
            readTimestampTranslations: function () {
                var t = this.element, e = "data-dt-", i = t.getAttribute(e + "months") || "";
                this.datetime = new c(g.compact({
                    phrases: {AM: t.getAttribute(e + "am"), PM: t.getAttribute(e + "pm")},
                    months: i.split("|"),
            ...
            var t, e, i = N, n = [];
            if (N = {}, i.keys)n = i.keys(); else for (t in i)i.hasOwnProperty(t) && n.push(t);
            n.length && (y.init(), e = i[n[0]][0].lang, v.tweets({
                ids: n.sort(), lang: e, complete: function (t) {
            ...
            }), p.every.apply(null, S).then(function () {
                y.flush()
            }), S = [])
    ...
    42: [function (t, e) {
        ...
        i.prototype = new o, r.aug(i.prototype, {
            iframeSource: "widgets/follow_button.c76e16b96e6a61165ecec3446016b1ee.{{lang}}.html",
            widgetUrlParams: function () {
                return r.compact({
            ...
            width: function () {
                ...
                var t, e, i = {
                    ...
                    xlcnt: 22,
                    xlbtn: 38
                }, n = this.showScreenName ? "Follow %{screen_name}" : "Follow", o = this._(n, {screen_name: "@" + this.screenName}), s = this._(r.contains(["ja", "ko"], this.lang) ? "10k unit" : "M"), a = this._("%{followers_count} followers", {followers_count: "88888" + s}), u = 0, c = 0, d = this.styles.base;
    ...
    43: [function (t, e) {
        ...
        function r(t, e) {
            if (h.isTwitterURL(t))if (p.get("eventsHub") && e) {
    ...
    44: [function (t, e) {
        ...
        var o, s, a, l = t("env/document"), u = t("tfw/widget/base"), c = t("tfw/widget/intent"), d = t("globals/pagemetadata"), h = t("tfw/util/media"), f = t("scribe/pixel"), m = t("video/video_post_message_interface"), p = t("dom/classname"), g = t("dom/get"), w = t("dom/delegate"), v = t("dom/size"), b = t("sandbox/frame"), y = t("util/env"), _ = t("util/promise"), T = t("util/twitter"), x = t("util/typevalidator"), E = t("util/util"), A = [".customisable", ".customisable:link", ".customisable:visited", ".customisable:hover", ".customisable:focus", ".customisable:active", ".customisable-highlight:hover", ".customisable-highlight:focus", "a:hover .customisable-highlight", "a:focus .customisable-highlight"], I = ["a:hover .ic-mask", "a:focus .ic-mask"], N = [".customisable-border"], S = [".timeline-header h1.summary", ".timeline-header h1.summary a:link", ".timeline-header h1.summary a:visited"], D = {
            TWEET: 0,
            RETWEET: 10
        };
        n.prototype = new u, E.aug(n.prototype, {
            styleSheetUrl: function () {
                ...
                var e = this;
                this.sandbox = t, _.some(e.applyInitialSandboxStyles(t), t.appendCss(".SandboxRoot { display:none }"), t.setBaseTarget("_blank"), t.appendStyleSheet(this.styleSheetUrl(this.lang))).then(function () {
                ...
                var e, i, n = {};
                return t ? (e = t.getAttribute("data-tweet-id"), i = t.getAttribute("data-rendered-tweet-id") || e, i == e ? n[i] = {item_type: D.TWEET} : e && (n[i] = {
                    item_type: D.RETWEET,
                    target_type: D.TWEET,
                    target_id: e
                }), n) : n
    ...
    45: [function (t, e) {
        ...
        var n = t("env/window"), r = t("assets/css"), o = t("tfw/widget/base"), s = t("tfw/widget/syndicatedbase"), a = t("util/datetime"), l = t("anim/transition"), u = t("performance/perf-timers"), c = t("tfw/util/data"), d = t("tfw/util/media"), h = t("scribe/audience"), f = t("scribe/frame"), m = t("tfw/util/params"), p = t("util/css"), g = t("util/env"), w = t("util/typevalidator"), v = t("util/util"), b = t("dom/delegate"), y = t("dom/classname"), _ = t("dom/get"), T = t("util/donottrack"), x = t("util/document"), E = t("globals/twttr"), A = t("globals/private"), I = {
            CLIENT_SIDE_USER: 0,
            CLIENT_SIDE_APP: 2
        }, N = ".timeline", S = ".new-tweets-bar", D = ".timeline-header", R = ".timeline-footer", k = ".stream", L = ".h-feed", P = ".tweet", C = ".detail-expander", M = ".expand", O = ".permalink", F = ".no-more-pane", j = "expanded", H = "pending-scroll-in", W = "pending-new-tweet-display", U = "pending-new-tweet", q = 0;
        i.prototype = new s, v.aug(i.prototype, {
            ...
            create: function (t) {
                ...
                return s.innerHTML = t.body, (e = s.children[0] || !1) ? (this.reconfigure(t.config), this.discardStaticOverflow(e), this.sandbox.setTitle(e.getAttribute("data-iframe-title") || "Timeline"), d.retinize(e), this.constrainMedia(e), this.searchQuery = e.getAttribute("data-search-query"), this.profileId = e.getAttribute("data-profile-id"), this.timelineType = e.getAttribute("data-timeline-type"), r = this.getTweetDetails(s.querySelector(L)), v.forIn(r, function (t) {
                    ...
                    element: "initial",
                    action: a.length ? "results" : "no_results"
                }, n, !0), h.scribeTimelineAudienceImpression(), f.flush(), "assertive" == this.ariaPolite && (i = e.querySelector(S), i.setAttribute("aria-polite", "assertive")), e.id = this.id, e.className += " " + this.classAttr.join(" "), e.lang = this.lang, this.ready().then(function (t) {
            ...
            update: function () {
                var t = this, e = this.element.querySelector(L), i = e && e.children[0], n = i && i.getAttribute("data-tweet-id");
                this.updateTimeStamps(), this.requestTweets(n, !0, function (e) {
                    e.childNodes.length > 0 && t.insertNewTweets(e)
                })
            },
            loadMore: function () {
                var t = this, e = v.toRealArray(this.element.querySelectorAll(P)).pop(), i = e && e.getAttribute("data-tweet-id");
            ...
            forceLoad: function () {
                var t = this, e = !!this.element.querySelectorAll(L).length;
            ...
            insertNewTweets: function (t) {
                var e, i = this, r = this.element.querySelector(k), o = r.querySelector(L), s = o.offsetHeight;
            ...
            gcTweets: function (t) {
                var e, i = this.element.querySelector(L), n = i.children.length;
                for (t = t || 50; n > t && (e = i.children[n - 1]); n--)i.removeChild(e)
            },
            showNewTweetNotifier: function () {
                var t = this, e = this.element.querySelector(S), i = e.children[0];
            ...
            hideStreamScrollBar: function () {
                var t, e = this.element.querySelector(k), i = this.element.querySelector(L);
            ...
            handleResize: function (t, e) {
                ...
                (n != this.width || e != this.height) && (this.width = n, this.height = e, this.setNarrow(), this.constrainMedia(this.element, this.contentWidth(n)), this.staticTimeline ? this.layout(function () {
                    i.height = i.element.offsetHeight, i.sandbox.height(i.height), E.get("events").trigger("resize", {target: i.sandbox.element()})
    ...
    46: [function (t, e) {
        ...
        i.prototype = new o, a.aug(i.prototype, {
            iframeSource: "widgets/tweet_button.b44aac737ba5fb3711801841c2833c12.{{lang}}.html",
            widgetUrlParams: function () {
                return a.compact({
                    text: this.text,
                    url: this.url,
            ...
            width: function () {
                ...
                }), r = this._("K"), o = this._("100K+"), s = (e ? "8888" : "88888") + r, l = 0, u = 0, d = 0, h = 0, f = this.styles.base, m = f;
    ...
    47: [function (t, e) {
        ...
        function n(t, e) {
            var i = {};
            i[t] = {item_type: 0}, p.clientEvent({
                page: "video",
                component: "tweet",
                action: "results"
            }, d.aug({}, e, {item_ids: [t], item_details: i}), !0), m.scribeVideoAudienceImpression()
        }
    ...
    }, {"env/location": 10, "util/uri": 66, "util/util": 67}],
    51: [function (t, e) {
        function i() {
            l = 1;
    ...
    53: [function (t, e) {
        ...
        var h = t("env/document"), f = t("env/navigator"), m = t("env/window"), p = t("util/domready"), g = t("util/typevalidator"), w = t("util/logger"), v = t("globals/pagemetadata"), b = t("globals/private"), y = f.userAgent, _ = !1, T = !1, x = "twitter-csp-test";
    ...
    }, {"env/location": 10, "env/window": 12, "util/util": 67}],
    58: [function (t, e) {
        function i(t) {
            return function (e) {
    ...
    }, {"util/typevalidator": 64, "util/util": 67}],
    59: [function (t, e) {
    ...
    66: [function (t, e) {
        ...
        function n() {
            for (var t, e = o.getElementsByTagName("link"), n = 0; t = e[n]; n++)if ("canonical" == t.rel)return i(t.href)
        }

        function r() {
            for (var t, e, i, n = o.getElementsByTagName("a"), r = o.getElementsByTagName("link"), s = [n, r], l = 0, u = 0, c = /\bme\b/; t = s[l]; l++)for (u = 0; e = t[u]; u++)if (c.test(e.rel) && (i = a.screenName(e.href)))return i
        }

        var o = t("env/document"), s = t("env/location"), a = t("util/twitter");
        e.exports = {absolutize: i, getCanonicalURL: n, getScreenNameFromPage: r}
    }, {"env/document": 9, "env/location": 10, "util/twitter": 63}],
    67: [function (t, e) {
        function i(t) {
    ...
    68: [function (t, e) {
        ...
        function n() {
            ...
            if ("function" === (typeof arguments[0]).toLowerCase() ? d.success = arguments[0] : d = arguments[0], t = d.success || function () {
                ...
                }, u = void 0 !== d.attempt ? d.attempt : m, !l.isDynamicWidget() || o)return r(), s(), !1;
            c = i(), u--;
            try {
    ...
    }, {"env/location": 10, "env/window": 12, "tfw/util/env": 37, "util/env": 53}],
    69: [function (t, e) {
        e.exports = {version: "9d4e0b0d707348003c9dafbf1d0cd36f33d92050:1425507437997"}
    }, {}],
    70: [function (t, e) {
        e.exports = {css: "6fb6fef1147ea6a3114d61e3e19df9d1"}
    }, {}],
    71: [function (t, e) {
        function i(t, e) {
        ...
        a.prototype.findIframeByWindow = function (t) {
            for (var e = this.global.document.getElementsByTagName("iframe"), i = e.length, n = 0; i > n; n++)if (e[n].contentWindow == t)return e[n]
    ...
    }, {"dom/get": 6, "rpc/jsonrpc/server": 23, "rpc/postmessage": 24, "scribe/pixel": 30, "util/util": 67}],
    72: [function (t) {
        !function () {
            var e = t("env/document"), i = t("env/navigator"), n = Function && Function.prototype && Function.prototype.bind, r = /MSIE [678]/.test(i.userAgent);
            if (n && !r) {
                var o = t("tfw/util/article"), s = t("util/domready"), a = t("util/logger"), l = t("performance/perf-timers"), u = t("tfw/widget/base"), c = t("tfw/widget/follow"), d = t("tfw/widget/tweetbutton"), h = t("tfw/widget/embed"), f = t("tfw/widget/timeline"), m = t("tfw/widget/video"), p = t("tfw/widget/intent"), g = t("tfw/factories"), w = t("util/events"), v = t("tfw/hub/client"), b = t("intents/delegate"), y = t("globals/twttr"), _ = t("globals/private"), T = t("events/ready"), x = t("util/promise");
