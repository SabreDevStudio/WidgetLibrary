...
(function () {
    var l = null, p = function () {
        ...
        function A(a, e) {
            ...
            g ? b.da(e.k) : g = e.Y();
            var m = e.g, k = y(m);
            if (g)b.ba(e.T()), k = k && k.replace(x, ""); else if (g = !!m) {
                if (47 !== k.charCodeAt(0))var k = y(b.g || "").replace(x, ""), s = k.lastIndexOf("/") + 1, k = y((s ? k.substring(0, s) : "") + y(m)).replace(x, "")
            } else k = k && k.replace(x, ""), k !== m && b.G(k);
            g ? b.G(k) : g = e.Z();
            g ? b.M(e.l) : g = e.X();
            g && b.ea(e.n);
            return b
        ...
        b.prototype.aa = function (a) {
            ...
            for (var e = [], b = "", k = 0; k < a.length;)g = a[k++],
    ...
    L.N = {NOT_LOADED: 0, SAME_DOCUMENT: 1, NEW_DOCUMENT: 2};
    L.ueffects = L.N;
    L.J = {
        "a::href": 2,
        "area::href": 2,
    ...
    L.URIEFFECTS = L.J;
    L.L = {UNSANDBOXED: 2, SANDBOXED: 1, DATA: 0};
    L.ltypes = L.L;
    L.I = {
        "a::href": 2,
        "area::href": 2,
    ...
    var Q = function (e) {
        function z(f) {
            if (G.hasOwnProperty(f))return G[f];
            var a = f.match(R);
        ...
        function q(f) {
            ...
            return function (f, e) {
                ...
                var b = /(<\/|<\!--|<[!?]|[&<>])/g;
                c = f + "";
                if (Y)c = c.split(b); else {
                    for (var i = [], h = 0, n; (n = b.exec(c)) !== l;)i.push(c.substring(h, n.index)), i.push(n[0]), h = n.index + n[0].length;
                ...
                for (var b,
                    ...
                    switch (r) {
                        case "&":
                            ...
                            break;
                        case "</":
                            if (b = /^([-\w:]+)[^\'\"]*/.exec(k))if (b[0].length === k.length && ">" === a[d + 1])d += 2, h = b[1].toLowerCase(), f.r && f.r(h, c, t, m(f, a, d, j, c)); else {
                                var g = a, o = d, q = f, s = c, v = t, y = j, x = D(g, o);
                                x ? (q.r && q.r(x.name, s, v, m(q, g, o, y, s)), d = x.next) : d = g.length
                            } else f.d && f.d("&lt;/", c, t, m(f, a, d, j, c));
                            break;
                        case "<":
                            if (b = /^([-\w:]+)\s*\/?/.exec(k))if (b[0].length === k.length &&
                                ">" === a[d + 1]) {
                                d += 2;
                                h = b[1].toLowerCase();
                                f.v && f.v(h, [], c, t, m(f, a, d, j, c));
                                var z = e.f[h];
                                z & O && (d = E(a, {name: h, next: d, c: z}, f, c, t, j))
                            } else {
        ...
        function E(a, w, d, j, c, u) {
            ...
            r < i && (r -= 1);
            i = a.slice(n, r).join("");
            if (w.c & e.c.CDATA)d.z && d.z(i, j, c, m(d, a, r, u, j)); else if (w.c & e.c.RCDATA)d.F && d.F(b(i), j, c, m(d, a, r, u, j)); else throw Error("bug");
            return r
        }
        ...
        function D(a, b) {
            ...
            j.c = e.f[j.name];
            for (var c = a[b].substr(d[0].length), u = b + 1, i = a.length; u < i && ">" !== a[u]; u++)c += a[u];
            if (!(i <= u)) {
                for (var h = []; "" !==
                c;)if (d = $.exec(c))if (d[4] && !d[5] || d[6] && !d[7]) {
                    for (var d = d[4] || d[6], n = !1, c = [c, a[u++]]; u < i; u++) {
                        if (n) {
                            if (">" === a[u])break
                        } else 0 <= a[u].indexOf(d) && (n = !0);
                        c.push(a[u])
                    }
                    if (i <= u)break;
                    c = c.join("")
                    ...
                    if (d[2]) {
                        ...
                        if (34 === g || 39 === g)r = r.substr(1, r.length - 2);
                        r = y(r.replace(aa, ""))
                    } else r = "";
                    h.push(n, r);
                ...
                startDoc: function () {
                    ...
                    if (!j && e.f.hasOwnProperty(c)) {
                        ...
                        if (!(h & e.c.FOLDABLE)) {
                            var n = a(c, b);
                            if (n) {
                                if ("object" !== typeof n)throw Error("tagPolicy did not return object (old API?)");
                    ...
                    if (j)j = !1; else if (e.f.hasOwnProperty(a)) {
                        var b = e.f[a];
                        if (!(b & (e.c.EMPTY | e.c.FOLDABLE))) {
                            if (b & e.c.OPTIONAL_ENDTAG)for (b = d.length; 0 <= --b;) {
                                var h = d[b].D;
                                if (h === a)break;
                                if (!(e.f[h] & e.c.OPTIONAL_ENDTAG))return
                            } else for (b = d.length; 0 <= --b && d[b].D !== a;);
                            if (!(0 > b)) {
                                for (h = d.length; --h > b;) {
                                    var g = d[h].t;
                    ...
                    for (; d.length; d.length--)a.push("</", d[d.length - 1].t, ">")
                }
            })
        }
        ...
        function g(b, g, d, j, c) {
            for (var k = 0; k < g.length; k += 2) {
                ...
                if ((o = b + "::" + i, e.w.hasOwnProperty(o)) || (o = "*::" + i, e.w.hasOwnProperty(o)))m = e.w[o];
                if (m !== l)switch (m) {
                    case e.e.NONE:
                        break;
                    case e.e.SCRIPT:
        ...
        function K(a, b, d) {
            return function (j, c) {
                if (e.f[j] & e.c.UNSAFE)d && v(d, j, void 0, void 0, void 0); else return {attribs: g(j, c, a, b, d)}
            }
        }
        ...
        var G = {
            ...
            apos: "'",
            nbsp: "\u00a0"
        }, R = /^#(\d+)$/, S = /^#x([0-9A-Fa-f]+)$/, T = /^[A-Za-z][A-za-z0-9]+$/, H = "undefined" !== typeof window && window.document ? window.document.createElement("textarea") : l, aa = /\0/g, U = /&(#[0-9]+|#[xX][0-9A-Fa-f]+|\w+);/g, Z = /^(#[0-9]+|#[xX][0-9A-Fa-f]+|\w+);/, V = /&/g, X = /&([^a-z#]|#(?:[^0-9x]|x(?:[^0-9a-f]|$)|$)|$)/gi, M = /[<]/g, N = />/g, W = /\"/g, $ = /^\s*([-.:\w]+)(?:\s*(=)\s*((")[^"]*("|$)|(')[^']*('|$)|(?=[a-z][-\w]*\s*=)|[^"'\s]*))?/i, Y = 3 === "a,b".split(/(,)/).length, O = e.c.CDATA | e.c.RCDATA, t = {}, I = {}, ba = /^(?:https?|mailto)$/i, o = {};
...
gapi.config.foldConfig = function (a, b) {
    if (b)for (var c in b)b.hasOwnProperty(c) && (a[c] && b[c] && "object" === typeof a[c] && "object" === typeof b[c] && !gapi.config.isArray(a[c]) && !gapi.config.isArray(b[c]) ? gapi.config.foldConfig(a[c], b[c]) : b[c] && "object" === typeof b[c] ? (a[c] = gapi.config.isArray(b[c]) ? [] : {}, gapi.config.foldConfig(a[c], b[c])) : a[c] = b[c])
};
gapi.config.getSelfScriptTags = function () {
    ...
    for (var d = 0; d < a.length; ++d)for (var e = a[d], f = 0; f < c.length; ++f)e.src && 0 == e.src.indexOf(c[f]) && b.push(e);
    0 == b.length && 0 < a.length && a[a.length - 1].src && b.push(a[a.length - 1]);
    return b
};
gapi.config.appendInlineConfig = function () {
    for (var a = gapi.config.jslComponent(gapi.config.USER_CFG_KEY), b = gapi.config.getSelfScriptTags(), c = 0; c < b.length; ++c)if (!b[c].getAttribute(gapi.config.ATTR_PROCESSED_CONFIG)) {
...
gapi.config.mergeConfig = function (a) {
    ...
    a = 0;
    for (b = d.length; a < b; ++a)gapi.config.foldConfig(gapi.config.cfg(), d[a]);
    d = gapi.config.jslComponent(gapi.config.INJECTED_CFG_KEY);
    a = 0;
    for (b = d.length; a < b; ++a)gapi.config.foldConfig(gapi.config.cfg(), d[a]);
    a = 0;
    for (b = c.length; a < b; ++a)gapi.config.foldConfig(gapi.config.cfg(), c[a])
};
gapi.config.get = function (a, b) {
    if (!a)return gapi.config.cfg();
    for (var c = a.split("/"), d = gapi.config.cfg(), e = 0, f = c.length; d && "object" === typeof d && e < f; ++e)d = d[c[e]];
    return e === c.length && void 0 !== d ? d : b
};
gapi.config.update = function (a, b) {
    var c = a;
    if ("string" === typeof a) {
        for (var d = c = {}, e = a.split("/"), f = 0, g = e.length; f < g - 1; ++f)var h = {}, d = d[e[f]] = h;
        d[e[f]] = b
    }
