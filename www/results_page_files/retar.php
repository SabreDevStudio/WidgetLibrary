if (document.createElement) {
	...
	if (veoxa_if) {
		veoxa_if.setAttribute("src", ('https:' == document.location.protocol ? 'https://' : 'http://') + "vu.adschoom.com/trafic/retar_js.php?type=CATEGORIE&boutique={submarinoviagens}&categorie_id={passagen-aerea}&produit_id=&data=&transaction_id=0&transaction_amount=0&valid=1" + '&refer=' + escape(refer) + "&refer2=" + refer2 + "&random=" + Math.round(Math.random() * 1000000000)); 
