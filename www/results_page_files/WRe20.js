...
!function () {
    ...
    if (!s) {
        ...
        if (t) {
            ...
            var o = window.ClickTaleGlobal;
            o || (o = {}, window.ClickTaleGlobal = o);
            o.exports = o.exports || {};
            p = t = o
        }
        p.exports.proxy = p.exports.proxy || {};
        s = p.exports.proxy
    }
    q = s;
    var n, m = r.ClickTaleSettings;
    "object" !== typeof m && (m = null);
    n = (m || {}).Proxy || {};
    var l = n.ImageFlag, k = n.WR;
    q.wrMessagesHandler = q.imageFlagHandler = null;
    "string" === typeof l && l.length && (q.imageFlagHandler = l);
    "string" === typeof k && k.length && (q.wrMessagesHandler = k)
}();
!function () {
    var i;
    var h;
    ...
    if (!h) {
        ...
        if (i) {
            ...
            var j = window.ClickTaleGlobal;
            j || (j = {}, window.ClickTaleGlobal = j);
            j.exports = j.exports || {};
            k = i = j
        }
        k.exports.proxy = k.exports.proxy || {};
        h = k.exports.proxy
    }
    l = h;
    n = l.wrMessagesHandler;
    m = l.imageFlagHandler;
    window.WRDr = n;
    window.WRDs = m
}();
if (!window.WRClickTaleOnReadyInvoked) {
    var WRWarn = "Copyright 2006-2015 ClickTale Ltd., US Patent and US Patent Pending", WRA, WRCP, WRD = document, WRCR, WRAp, WRs, WRK, WRBt, WRE = ".clicktale.net/", WRDq = WRDs, WRDp = WRDr, WRAH, WRk, WRBR, WRCQ, WRB = [], WRt, ClickTaleCookieDomain, ClickTaleUnloadPause = 200, ClickTaleEventsMask = 511 - 128, ClickTaleFetchFrom, ClickTaleCookieExpiryDays = 365, ClickTaleUIDCookieName = "WRUID", ClickTaleIgnoreCookieName = "WRIgnore", WRBO, WRAS, WRDi = false, WRAE, WRAL, WRAM, WRAN, WRAO, WRBS = WRCZ(), WRCS = false, WRCX = false, WRCa = false, WRC, WRCc = "", WRCY = false, WRCd = false, WRDA = false, WRDB = false, WRDC = false, WRDD = "", WRDE = {}, WRDF = {}, WRClickTaleOnReadyInvoked = false, ClickTaleLog = WRDG, WRDa = "&", WRDb = "=", WRC4 = 0;
    (function (a) {
...
function ClickTale(d, e, a) {
    ...
    WRCP = a;
    WRAr("note2: preparing to record (ver " + 14 + "." + 20 + ") for project id " + d + " and partition " + a);
    if (e == 1) {
...
function ClickTaleNote(a) {
    WRZ({a: "note", c: a, t: WRH()})
}
function ClickTaleField(b, a) {
    WRZ({a: "field", f: b, v: a, t: WRH()})
}
function ClickTaleExec(a) {
    if (a.length > 2000 && WRBR.XDR) {
        WRZ({a: "exec", streamval: a, t: WRH()})
    } else {
        WRZ({a: "exec", c: a, t: WRH()})
    }
}
function ClickTaleRegisterFormSubmitSuccess(b) {
    if (WRBw()) {
        ...
        if (b == null) {
            WRZ({a: "submitsuccess", i: false, t: WRH()})
        }
    }
}
function ClickTaleRegisterFormSubmitFailure(b) {
    if (WRBw()) {
        ...
        if (b == null) {
            WRZ({a: "submitfail", i: false, t: WRH()})
        }
    }
}
...
function WRBm(b) {
    ...
    while ((a = c.exec(e)) != null) {
        d[a[1]] = {value: a[2], extra: a[3]};
        c.lastIndex--
    }
    return d
}
function WRBb(b) {
    var c = {IE: 0, FF: 1, Ch: 2, Sa: 3, Op: 4, WK: 5};
    var f = WRBm(b);
    if (f.Opera) {
        c.t = c.Op;
        c.v = 0;
...
(function () {
        ...
        if (!r && q != p) {
            if (0 < p && 4 > p) {
                ...
                if (4 == p) {
                    ...
                    o = {status: o, statusText: n, headers: g, responseText: i};
                    aF && aF(o);
    ...
    var m = window, l = void 0, l = function () {
        ...
        var n = aP;
        if (n = o.IM) {
            if (g.r = {g: []}, o = aP, (o = n.Urls) && o.length) {
                for (n = 0; n < o.length; n++) {
                    var k = o[n];
                    g.r.g.push({n: k.UrlRule, w: k.FetcherDoRewriteRules, s: k.IMRewriteRulesSet})
                }
            }
        }
        var j = g.f;
