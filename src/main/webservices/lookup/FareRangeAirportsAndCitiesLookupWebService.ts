...
class FareRangeAirportsAndCitiesLookupWebService extends WebService {
    ...
    {
        super('/v1/lists/supported/historical/flights/origins-destinations/'
            , $resource
...
export = FareRangeAirportsAndCitiesLookupWebService;