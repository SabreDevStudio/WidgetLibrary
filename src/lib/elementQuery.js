// WARN: modified original file by:
// 1. adding fallback to document.querySelectorAll when neither Sizzle or jQuery are present.
// 2. making sure sizzle call context is set: line with elements = sizzle.call(document, i);, instead of elements = sizzle(i);
// Such change was already requested (but not merged yet) on github for this component
